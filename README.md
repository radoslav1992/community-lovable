...
- **Lovable значки** — членовете свързват публичния си Lovable профил
  (`lovable.dev/@потребител`); собствеността се доказва автоматично с
  еднократен код, поставен в биото на профила (без админ одобрение). Значките
  от профила (напр. „Top 10% of Lovable users“) се разчитат при потвърждение
  и се ресинхронизират на всеки 7 дни. Всеки Lovable профил може да се
  свърже само с един акаунт
